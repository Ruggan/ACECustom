...
namespace ACE.Server.Managers
{
    ...
    public class AllegianceManager
    {
        ...
        {
            WorldManager.EnqueueAction(new ActionEventDelegate(ActionType.AllegianceManager_PassXP, () => DoPassXP(vassalNode, amount, direct, luminance)));
        }
        ...
        {
            WorldManager.EnqueueAction(new ActionEventDelegate(ActionType.AllegianceManager_HandlePlayerDelete, () => DoHandlePlayerDelete(playerGuid)));
        }
